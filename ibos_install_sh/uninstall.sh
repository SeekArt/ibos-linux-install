...
echo "/ibos/server/mysql             delete ok!" 
rm -rf /ibos/server/mysql
echo "rm -rf /ibos/server/mysql-*    delete ok!"
rm -rf /ibos/server/mysql-*
echo "/ibos/server/php               delete ok!"
rm -rf /ibos/server/php
echo "/ibos/server/php-*             delete ok!"
rm -rf /ibos/server/php-*
echo "/ibos/server/nginx             delete ok!"
rm -rf /ibos/server/nginx
echo "rm -rf /ibos/server/nginx-*    delete ok!"
rm -rf /ibos/server/nginx-*
echo "/ibos/server/httpd             delete ok!"
rm -rf /ibos/server/httpd
echo "/ibos/server/httpd-*           delete ok!"
rm -rf /ibos/server/httpd-*
echo ""
echo "/ibos/log/php                  delete ok!"
rm -rf /ibos/log/php
echo "/ibos/log/mysql                delete ok!"
rm -rf /ibos/log/mysql
echo "/ibos/log/nginx                delete ok!"
rm -rf /ibos/log/nginx
echo "/ibos/log/httpd                delete ok!"
rm -rf /ibos/log/httpd
echo ""
echo "/ibos/www              delete ok!"
rm -rf /ibos/www
...
sed -i "/export PATH=\$PATH\:\/ibos\/server\/mysql\/bin.*/d" /etc/profile
source /etc/profile
