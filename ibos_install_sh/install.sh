...
web=nginx
install_log=/ibos/website-info.log
...
/ibos/server/php/bin/php -f ./res/init_mysql.php
...
if echo $web|grep "nginx" > /dev/null;then
  echo 'export PATH=$PATH:/ibos/server/mysql/bin:/ibos/server/nginx/sbin:/ibos/server/php/sbin:/ibos/server/php/bin' >> /etc/profile
  export PATH=$PATH:/ibos/server/mysql/bin:/ibos/server/nginx/sbin:/ibos/server/php/sbin:/ibos/server/php/bin
else
  echo 'export PATH=$PATH:/ibos/server/mysql/bin:/ibos/server/httpd/bin:/ibos/server/php/sbin:/ibos/server/php/bin' >> /etc/profile
  export PATH=$PATH:/ibos/server/mysql/bin:/ibos/server/httpd/bin:/ibos/server/php/sbin:/ibos/server/php/bin
fi
