...
make install
cd ..
cp ./php-5.3.29/php.ini-production /ibos/server/php/etc/php.ini
#adjust php.ini
sed -i 's#; extension_dir = \"\.\/\"#extension_dir = "/ibos/server/php/lib/php/extensions/no-debug-non-zts-20090626/"#'  /ibos/server/php/etc/php.ini
sed -i 's#extension_dir = \"\.\/\"#extension_dir = "/ibos/server/php/lib/php/extensions/no-debug-non-zts-20090626/"#'  /ibos/server/php/etc/php.ini
